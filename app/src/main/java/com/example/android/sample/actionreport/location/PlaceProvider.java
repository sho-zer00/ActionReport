package com.example.android.sample.actionreport.location;
...
public class PlaceProvider extends ContentProvider {
    ...
    // <authority>
    private static final String AUTHORITY    = "com.example.android.sample.actionreport.place";
    // <path>
    ...
    // 独自のMIME TYPEを設定する。
    public static final String MIME_ITEM = "vnd.actionreport.place";
